...
copyright(){
    output "Pterodactyl Installation & Upgrade script v25.6."
    output "Copyright © 2018 Thien Tran <thientran@securesrv.io>."
...
server_options() {
    ...
    output "[4] Install the standalone SFTP server (Only use this after you have installed and configured the daemon. Ubuntu 14.04 is NOT supported.)"
    output "[5] Upgrade 0.7.x panel to 0.7.12."
    output "[6] Upgrade 0.6.x daemon to 0.6.11."
    output "[7] Upgrade the standalone SFTP server to 1.0.4."
    output "[8] Install or Update to phpMyAdmin 4.8.5 (Only use this after you have installed the panel.)"
    output "[9] Change Pterodactyl theme."
    output "[10] Emergency MariaDB root password reset."
    output "[11] Emergency Database host information reset."
    warn "[12] Enable external Mariadb root login. (Warning: This is highly discourage as it is a security risk.)"
    output "[13] Disable external Mariadb root login. (Reversing [12].)"
    read choice
    case $choice in
        1 ) installoption=1
        ...
        11 ) installoption=11
            ...
            ;;
        12 ) installoption=12
            output "You have selected to enable external root login."
            ;;
        13 ) installoption=12
            output "You have selected to enable disable root login."
            ;;
...
upgrade_pterodactyl(){
    ...
    output "Your panel has been updated to version 0.7.12."
    php artisan up
...
upgrade_daemon(){
    ...
    output "Your daemon has been updated to version 0.6.11."
}
